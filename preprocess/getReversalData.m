function data = getReversalData(data_dir, subject_id)
%getReversalData - 逆転学習時のデータを取得する
%
% data_dirで指定されたフォルダからsubject_idに対応する逆転学習時のデータを取得する
%
% [書式]
